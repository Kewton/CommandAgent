...
| [`user/gui-trial.md`](user/gui-trial.md) | Four-route Gate 1–4 Trial flow, reconnect, and read-only lease recovery. | Mixed | End users |
| [`user/gui-history.md`](user/gui-history.md) | Compact Trial session summaries, refresh, detail routing, and A/B reading. | Mixed | End users |
