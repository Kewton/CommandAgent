...
裁定者誤り系譜（2026-08-03）: `p=0.17, N=6`の4窓で`>=1 full`期待を`3.4/4`とした依頼者算術を、実行前に`4 × (1 - 0.83^6) ≈ 2.69/4`へ訂正した。

裁定者誤り系譜（2026-08-04）: 上の丸め値`2.69/4`は正しかったが、中間値を`2.688076...`と転記した裁定者算術も誤りだった。正確には`1 - 0.83^6 = 0.673059626631...`、4窓期待は`2.692238506524...`。実行済みpredeclarationはSHA証跡のため不変とし、別 correction recordで訂正した。
