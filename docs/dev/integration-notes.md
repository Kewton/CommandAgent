...
| F-2 Luna CLI comparison | **COMPLETE; native window measured** | `uat-test0801-cli-luna-006` kept the local qwen planner and moved only the executor endpoint to Responses/native. It reached C checks 5/6; C3 was pass 2 / violation 1 / claims_absent 2, full 0/6, and cost USD 0.312987. Returned model/service tier were stable; fingerprint remained provider-null. |
