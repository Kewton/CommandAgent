...
| D-3d v0.1 post-full directives | **QUEUED** | D-3d v0 continues failed runs only. Treat a modification request after a full terminal as a newly confirmed revision configuration, not as failure recovery. |
