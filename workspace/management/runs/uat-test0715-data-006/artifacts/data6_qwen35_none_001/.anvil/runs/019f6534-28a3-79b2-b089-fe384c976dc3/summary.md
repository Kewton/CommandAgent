...
Paths:
- repair prompt saved: .anvil/repairs/repair-phase-load-and-inspect-data-019f653d-82f6-7063-b24f-c030f27bbb27.md
- Recovery UltraPlan YAML saved: .anvil/plans/recovery-ultra-plan-phase-load-and-inspect-data-019f653d-82f7-7d32-b004-cdf2200919e4.yaml
Commands:
- suggested command: /ultra-plan-run --profile data "$(cat .anvil/repairs/repair-phase-load-and-inspect-data-019f653d-82f6-7063-b24f-c030f27bbb27.md)"
- suggested YAML command: /run-ultra-plan .anvil/plans/recovery-ultra-plan-phase-load-and-inspect-data-019f653d-82f7-7d32-b004-cdf2200919e4.yaml
Profile: data
Assurance: failed (data_profile_script_not_generated)
Host env: NODE_ENV=production detected (verifiers ran with a cleaned environment)
Recovery handoff:
- Recovery prompt saved: .anvil/repairs/repair-phase-load-and-inspect-data-019f653d-82f6-7063-b24f-c030f27bbb27.md
- Recovery UltraPlan YAML saved: .anvil/plans/recovery-ultra-plan-phase-load-and-inspect-data-019f653d-82f7-7d32-b004-cdf2200919e4.yaml
- Suggested command: /ultra-plan-run --profile data "$(cat .anvil/repairs/repair-phase-load-and-inspect-data-019f653d-82f6-7063-b24f-c030f27bbb27.md)"
- Suggested YAML command: /run-ultra-plan .anvil/plans/recovery-ultra-plan-phase-load-and-inspect-data-019f653d-82f7-7d32-b004-cdf2200919e4.yaml
...
Time profile: provider 100% [prefill 2% · generation 98% · load 0%] · installs 0% · builds 0% · probe 0% · total 10m13s

Time profile by phase:
| Phase | Total | Provider | Installs | Builds | Probe | Other |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| load-and-inspect-data | 8m42s | 8m42s | 0s | 0s | 0s | 0s |
| unscoped | 1m32s | 1m32s | 0s | 0s | 0s | 0s |

Generation profile (duration-weighted eval tokens):
| Caller scope | Eval tokens | Duration | Turns |
| --- | ---: | ---: | ---: |
| planner | 20129 | 10m13s | 4 |

| Turn type | Eval tokens | Duration | Turns | Write bytes | Edit bytes |
| --- | ---: | ---: | ---: | ---: | ---: |
| prose-only | 20129 | 10m13s | 4 | 0B | 0B |
