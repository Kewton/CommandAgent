...
- Suspected files: `src/tui/footer.rs, src/tui/banner.rs, tests/tui_pty.rs, src/lib.rs, src/tui/spinner.rs, src/planner/runner.rs, src/tui/editor.rs, src/completion_metadata/data.rs`
- References: `none`
