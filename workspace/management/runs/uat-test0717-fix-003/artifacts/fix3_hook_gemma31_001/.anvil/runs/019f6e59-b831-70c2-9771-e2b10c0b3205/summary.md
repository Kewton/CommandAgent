...
Paths:
- repair prompt saved: .anvil/repairs/repair-phase-isolate-cause-019f6e5e-28cd-7d60-8ec0-a9ef08cd8597.md
- Recovery UltraPlan YAML saved: .anvil/plans/recovery-ultra-plan-phase-isolate-cause-019f6e5e-28cd-7d60-8ec0-a9fe713203ee.yaml
Commands:
- suggested command: /ultra-plan-run --profile nextjs "$(cat .anvil/repairs/repair-phase-isolate-cause-019f6e5e-28cd-7d60-8ec0-a9ef08cd8597.md)"
- suggested YAML command: /run-ultra-plan .anvil/plans/recovery-ultra-plan-phase-isolate-cause-019f6e5e-28cd-7d60-8ec0-a9fe713203ee.yaml
Profile: nextjs
...
Recovery handoff:
- Recovery prompt saved: .anvil/repairs/repair-phase-isolate-cause-019f6e5e-28cd-7d60-8ec0-a9ef08cd8597.md
- Recovery UltraPlan YAML saved: .anvil/plans/recovery-ultra-plan-phase-isolate-cause-019f6e5e-28cd-7d60-8ec0-a9fe713203ee.yaml
- Suggested command: /ultra-plan-run --profile nextjs "$(cat .anvil/repairs/repair-phase-isolate-cause-019f6e5e-28cd-7d60-8ec0-a9ef08cd8597.md)"
- Suggested YAML command: /run-ultra-plan .anvil/plans/recovery-ultra-plan-phase-isolate-cause-019f6e5e-28cd-7d60-8ec0-a9fe713203ee.yaml
...
Time profile: provider 100% [prefill 4% · generation 92% · load 4%] · installs 0% · builds 0% · probe 0% · total 4m51s

Time profile by phase:
| Phase | Total | Provider | Installs | Builds | Probe | Other |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| isolate-cause | 2m41s | 2m41s | 0s | 0s | 0s | 0s |
| reproduce-before | 2m11s | 2m11s | 0s | 0s | 0s | 0s |

Generation profile (duration-weighted eval tokens):
| Caller scope | Eval tokens | Duration | Turns |
| --- | ---: | ---: | ---: |
| executor | 772 | 50s | 3 |
| planner | 7690 | 3m47s | 2 |
| repair | 317 | 14s | 2 |

| Turn type | Eval tokens | Duration | Turns | Write bytes | Edit bytes |
| --- | ---: | ---: | ---: | ---: | ---: |
| prose-only | 7690 | 3m47s | 2 | 0B | 0B |
| tool-call | 1089 | 1m04s | 5 | 0B | 0B |
