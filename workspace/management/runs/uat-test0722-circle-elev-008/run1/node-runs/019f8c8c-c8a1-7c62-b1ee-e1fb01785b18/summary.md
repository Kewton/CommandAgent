...
Time profile: provider 100% [prefill 0% · generation 0% · load 0%] · installs 0% · builds 0% · probe 0% · total 7s

Time profile by phase:
| Phase | Total | Provider | Installs | Builds | Probe | Other |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| diagnose | 7s | 7s | 0s | 0s | 0s | 0s |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| full-file Write | 294 | 4s | 1 | 927B | 0B |
| tool-call | 110 | 4s | 3 | 0B | 0B |
