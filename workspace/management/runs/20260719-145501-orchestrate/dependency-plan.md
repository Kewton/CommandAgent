...
- Suspected files: `src/tui/footer.rs, src/tui/banner.rs, tests/tui_pty.rs, src/lib.rs, src/planner/ultra_plan_flow.rs, src/planner/runner.rs, src/minimal_loop/pipeline_probe/stream_capture.rs, src/completion_metadata/data.rs`
- References: `none`
