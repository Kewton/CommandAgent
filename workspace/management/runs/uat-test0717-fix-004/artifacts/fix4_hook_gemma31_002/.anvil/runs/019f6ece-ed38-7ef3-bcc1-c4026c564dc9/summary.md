...
Paths:
- repair prompt saved: .anvil/repairs/repair-phase-isolate-cause-019f6ed5-0176-72b2-9e13-2f228b9d0314.md
- Recovery UltraPlan YAML saved: .anvil/plans/recovery-ultra-plan-phase-isolate-cause-019f6ed5-0176-72b2-9e13-2f3f9c6796f0.yaml
Commands:
- suggested command: /ultra-plan-run --profile nextjs "$(cat .anvil/repairs/repair-phase-isolate-cause-019f6ed5-0176-72b2-9e13-2f228b9d0314.md)"
- suggested YAML command: /run-ultra-plan .anvil/plans/recovery-ultra-plan-phase-isolate-cause-019f6ed5-0176-72b2-9e13-2f3f9c6796f0.yaml
Profile: nextjs
...
Recovery handoff:
- Recovery prompt saved: .anvil/repairs/repair-phase-isolate-cause-019f6ed5-0176-72b2-9e13-2f228b9d0314.md
- Recovery UltraPlan YAML saved: .anvil/plans/recovery-ultra-plan-phase-isolate-cause-019f6ed5-0176-72b2-9e13-2f3f9c6796f0.yaml
- Suggested command: /ultra-plan-run --profile nextjs "$(cat .anvil/repairs/repair-phase-isolate-cause-019f6ed5-0176-72b2-9e13-2f228b9d0314.md)"
- Suggested YAML command: /run-ultra-plan .anvil/plans/recovery-ultra-plan-phase-isolate-cause-019f6ed5-0176-72b2-9e13-2f3f9c6796f0.yaml
...
Time profile: provider 100% [prefill 6% · generation 93% · load 1%] · installs 0% · builds 0% · probe 0% · total 6m38s

Time profile by phase:
| Phase | Total | Provider | Installs | Builds | Probe | Other |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| isolate-cause | 4m53s | 4m53s | 0s | 0s | 0s | 0s |
| reproduce-before | 1m45s | 1m45s | 0s | 0s | 0s | 0s |

Generation profile (duration-weighted eval tokens):
| Caller scope | Eval tokens | Duration | Turns |
| --- | ---: | ---: | ---: |
| executor | 3216 | 2m32s | 11 |
| planner | 8355 | 4m06s | 2 |

| Turn type | Eval tokens | Duration | Turns | Write bytes | Edit bytes |
| --- | ---: | ---: | ---: | ---: | ---: |
| prose-only | 8355 | 4m06s | 2 | 0B | 0B |
| tool-call | 3216 | 2m32s | 11 | 0B | 0B |
