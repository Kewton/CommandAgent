...
Time profile: provider 100% [prefill 3% · generation 96% · load 0%] · installs 0% · builds 0% · probe 0% · total 2m04s

Time profile by phase:
| Phase | Total | Provider | Installs | Builds | Probe | Other |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| diagnose | 2m04s | 2m04s | 0s | 0s | 0s | 0s |

Generation profile (duration-weighted eval tokens):
| Caller scope | Eval tokens | Duration | Turns |
| --- | ---: | ---: | ---: |
| executor | 714 | 10s | 2 |
| repair | 10405 | 1m55s | 3 |

| Turn type | Eval tokens | Duration | Turns | Write bytes | Edit bytes |
| --- | ---: | ---: | ---: | ---: | ---: |
| full-file Write | 1670 | 20s | 1 | 2416B | 0B |
| prose-only | 8192 | 1m29s | 1 | 0B | 0B |
| tool-call | 1257 | 16s | 3 | 0B | 0B |
