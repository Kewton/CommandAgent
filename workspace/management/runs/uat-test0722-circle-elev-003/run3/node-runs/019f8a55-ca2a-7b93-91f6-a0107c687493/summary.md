...
Time profile: provider 100% [prefill 0% · generation 0% · load 0%] · installs 0% · builds 0% · probe 0% · total 4s

Time profile by phase:
| Phase | Total | Provider | Installs | Builds | Probe | Other |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| diagnose | 4s | 4s | 0s | 0s | 0s | 0s |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| full-file Write | 290 | 3s | 1 | 949B | 0B |
| tool-call | 49 | 2s | 1 | 0B | 0B |
