...
| focused assertion failures surfaced by non-duplicated signoff | 18 |
...
the eval/report recheck projection subset. The four remaining focused
assertion failures are `focused-dispatch-manifest-repair`,
`focused-nextjs-dependency-setup`, `focused-nextjs-endpoint-smoke`, and
`focused-nextjs-route-integration`; they remain assigned to setup/profile,
dev-server, route-integration, and dispatch/action semantics in Phase35 or
later.
