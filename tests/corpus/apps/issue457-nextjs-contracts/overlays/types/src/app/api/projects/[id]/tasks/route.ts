...
export async function GET(
  ...
  try {
    ...
    if (projectsResult.error) {
      return NextResponse.json({ error: projectsResult.error.message, details: projectsResult.error.details }, { status: 500 });
    }
    ...
    if (tasksResult.error) {
      return NextResponse.json({ error: tasksResult.error.message, details: tasksResult.error.details }, { status: 500 });
    }
