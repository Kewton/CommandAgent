...
EXPECTED_FIELD_NAMES = [
    ...
    "expected_admitted_cluster_targets",
    ...
    "expected_setup_job_kind",
    "expected_setup_job_state",
    "expected_setup_target",
    "expected_setup_manifest_kind",
    "expected_setup_state",
    "expected_setup_manifest_path",
    "expected_setup_artifact_validation_status",
    "expected_setup_readiness",
    "expected_setup_command_authority",
    "expected_setup_attempt_key",
    "expected_setup_manifest_fingerprint",
    "expected_setup_stale_reason",
    "expected_setup_result",
    "expected_setup_failure_signature",
    ...
    "expected_profile_project_kind",
    "expected_profile_manifest_artifacts",
    "expected_profile_entrypoints",
    "expected_profile_integration_artifacts",
    "expected_profile_completion_evidence",
    "expected_profile_failure_mapping",
    "expected_profile_adapter_families",
    "expected_profile_capability_status",
